...
A 1.12.2 port of [Accurate Block Placement Reborn](https://modrinth.com/mod/accurate-block-placement-reborn) by Clayborn, Flourick, KadTheHunter and schwar.
...
- [MixinBooter](https://www.curseforge.com/minecraft/mc-mods/mixin-booter) 9.0 or newer

## Installation

1. Install Forge for 1.12.2.
2. Install MixinBooter.
3. Put `accurateblockplacement-1.3.0.jar` in your `mods` folder.
